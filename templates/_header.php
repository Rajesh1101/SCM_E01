...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="plugins/images/eleven01.png">
    <title>Eleven01 Supplychain DApp</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 sidebar">
            <div class="navbar-header"> 
                <div class="top-left-part"><a class="logo" href="index.php"><b><img src="plugins/images/eleven01.png" alt="home" /></b><span class="hidden-xs"> Eleven01</span></a></div>
            </div>
        </nav>
        <!-- Left navbar-header -->
