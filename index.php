...
<head>
    ...
    <title>Eleven01 Supplychain Management DApp</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="white-box">
                    ...
                    <div class="form-group text-center">
                        <div class="col-xs-6 p-b-20">
                         ...
                         <div class="col-xs-6 p-b-20">
                            <a href="user.php" class="btn btn-rounded btn-block btn-info">User Login</a>
                        </div>
                        <div class="col-xs-6 p-b-20">
                            <a href="admin.php" class="btn btn-rounded btn-block btn-info">Admin Login</a>
                        </div>
                    </div>   
            </div>
        </div>
